...
mod length_extra {
    ...
    #[test]
    fn unicode_emoji() {
        assert_eq!(eval("length", &[s("\u{1F600}")]), i(1));
    }
    #[test]
    fn unicode_cjk() {
        assert_eq!(eval("length", &[s("\u{4E16}\u{754C}")]), i(2));
    }
    #[test]
    fn long_500() {
        assert_eq!(eval("length", &[s(&"a".repeat(500))]), i(500));
    }
    #[test]
    fn special_tab() {
    ...
    #[test]
    fn len_alias() {
        assert_eq!(eval("len", &[s("abc")]), i(3));
    }
    #[test]
    fn char_length_alias() {
        assert_eq!(eval("char_length", &[s("abc")]), i(3));
    }
    #[test]
    fn string_length_alias() {
        assert_eq!(eval("string_length", &[s("abc")]), i(3));
    }
    #[test]
    fn len_empty() {
...
mod upper_extra {
    ...
    #[test]
    fn mixed() {
        assert_eq!(eval("upper", &[s("aBcD")]), s("ABCD"));
    }
    #[test]
    fn digits() {
        assert_eq!(eval("upper", &[s("a1b2")]), s("A1B2"));
    }
    #[test]
    fn special() {
        assert_eq!(eval("upper", &[s("a!b")]), s("A!B"));
    }
    #[test]
    fn int_in() {
    ...
    #[test]
    fn long_str() {
        assert_eq!(eval("upper", &[s(&"ab".repeat(100))]), s(&"AB".repeat(100)));
    }
    #[test]
...
mod lower_extra {
    ...
    #[test]
    fn mixed() {
        assert_eq!(eval("lower", &[s("AbCd")]), s("abcd"));
    }
    #[test]
    fn digits() {
        assert_eq!(eval("lower", &[s("A1B2")]), s("a1b2"));
    }
    #[test]
    fn special() {
        assert_eq!(eval("lower", &[s("A!B")]), s("a!b"));
    }
    #[test]
    fn int_in() {
...
mod trim_extra {
    ...
    #[test]
    fn trim_single_char() {
        assert_eq!(eval("trim", &[s(" x ")]), s("x"));
    }

    #[test]
    fn ltrim_basic() {
        assert_eq!(eval("ltrim", &[s("  hi")]), s("hi"));
    }
    #[test]
    fn ltrim_none() {
        assert_eq!(eval("ltrim", &[s("hi")]), s("hi"));
    ...
    #[test]
    fn rtrim_basic() {
        assert_eq!(eval("rtrim", &[s("hi  ")]), s("hi"));
    }
    #[test]
    fn rtrim_none() {
        assert_eq!(eval("rtrim", &[s("hi")]), s("hi"));
...
mod substring_extra {
    ...
    #[test]
    fn basic() {
        assert_eq!(eval("substring", &[s("hello"), i(1), i(3)]), s("hel"));
    }
    #[test]
    fn from_start() {
    ...
    #[test]
    fn empty_str() {
        assert_eq!(eval("substring", &[s(""), i(1), i(3)]), s(""));
    }
    #[test]
    fn null_in() {
    ...
    #[test]
    fn beyond_len() {
        assert_eq!(eval("substring", &[s("hi"), i(1), i(100)]), s("hi"));
    }
    #[test]
    fn single_char() {
    ...
    fn long_string() {
        ...
        assert_eq!(eval("substring", &[s(&long), i(1), i(5)]), s("aaaaa"));
    }
}
...
mod concat_extra {
    ...
    #[test]
    fn two_strings() {
        assert_eq!(eval("concat", &[s("foo"), s("bar")]), s("foobar"));
    }
    #[test]
    fn three_strings() {
    ...
    #[test]
    fn empty_and_str() {
        assert_eq!(eval("concat", &[s(""), s("hi")]), s("hi"));
    }
    #[test]
    fn str_and_empty() {
        assert_eq!(eval("concat", &[s("hi"), s("")]), s("hi"));
    }
    #[test]
    fn both_empty() {
    ...
    #[test]
    fn with_null() {
        assert_eq!(eval("concat", &[s("hi"), null()]), s("hi"));
    }
    #[test]
    fn null_and_str() {
        assert_eq!(eval("concat", &[null(), s("hi")]), s("hi"));
    }
    #[test]
    fn all_null() {
    ...
    #[test]
    fn with_int() {
        assert_eq!(eval("concat", &[s("v"), i(42)]), s("v42"));
    }
    #[test]
    fn many_args() {
        assert_eq!(
    ...
    #[test]
    fn str_concat_alias() {
        assert_eq!(eval("str_concat", &[s("x"), s("y")]), s("xy"));
    }
    #[test]
    fn string_concat_alias() {
        assert_eq!(eval("string_concat", &[s("x"), s("y")]), s("xy"));
    }
}
...
mod replace_extra {
    ...
    fn basic() {
        assert_eq!(
            eval("replace", &[s("hello world"), s("world"), s("earth")]),
            s("hello earth")
        );
    }
    #[test]
    ...
    #[test]
    fn empty_search() {
        assert_eq!(eval("replace", &[s("hello"), s(""), s("x")]), s("hello"));
    }
    #[test]
    fn empty_replace() {
    ...
    #[test]
    fn replace_all() {
        assert_eq!(eval("replace", &[s("abcabc"), s("abc"), s("x")]), s("xx"));
    }
    #[test]
    fn replace_single_char() {
        assert_eq!(eval("replace", &[s("abc"), s("b"), s("B")]), s("aBc"));
    }
    #[test]
    fn empty_str() {
    ...
    #[test]
    fn long_input() {
        let long = "ab".repeat(500);
        let result = eval("replace", &[s(&long), s("ab"), s("cd")]);
        assert_eq!(result, s(&"cd".repeat(500)));
    }
}
...
mod starts_ends_contains {
    ...
    #[test]
    fn starts_full() {
        assert_eq!(eval("starts_with", &[s("hello"), s("hello")]), i(1));
    }
    #[test]
    fn starts_null() {
        assert_eq!(eval("starts_with", &[null(), s("h")]), null());
    }
    #[test]
    fn starts_empty_str() {
        assert_eq!(eval("starts_with", &[s(""), s("h")]), i(0));
    }
    #[test]
    fn starts_empty_both() {
    ...
    #[test]
    fn ends_full() {
        assert_eq!(eval("ends_with", &[s("hello"), s("hello")]), i(1));
    }
    #[test]
    fn ends_null() {
        assert_eq!(eval("ends_with", &[null(), s("o")]), null());
    }

    #[test]
    fn contains_true() {
        assert_eq!(eval("contains", &[s("hello world"), s("lo w")]), i(1));
    }
    #[test]
    fn contains_false() {
    ...
    #[test]
    fn contains_null() {
        assert_eq!(eval("contains", &[null(), s("h")]), null());
    }
    #[test]
...
mod reverse_extra {
    ...
    #[test]
    fn digits() {
        assert_eq!(eval("reverse", &[s("123")]), s("321"));
    }
    #[test]
    fn spaces() {
    ...
    fn long_str() {
        ...
        let rev: String = long.chars().rev().collect();
        assert_eq!(eval("reverse", &[s(&long)]), s(&rev));
    }
}
...
mod left_right_extra {
    ...
    #[test]
    fn left_beyond() {
        assert_eq!(eval("left", &[s("hello"), i(100)]), s("hello"));
    }
    #[test]
    fn left_empty() {
    ...
    #[test]
    fn right_beyond() {
        assert_eq!(eval("right", &[s("hello"), i(100)]), s("hello"));
    }
    #[test]
    fn right_empty() {
...
mod pad_extra {
    ...
    #[test]
    fn lpad_null() {
        assert_eq!(eval("lpad", &[null(), i(3), s("x")]), null());
    }
    #[test]
    fn lpad_space() {
    ...
    #[test]
    fn lpad_zero_len() {
        assert_eq!(eval("lpad", &[s("hi"), i(0), s("x")]), s(""));
    }
    ...
    #[test]
    fn rpad_null() {
        assert_eq!(eval("rpad", &[null(), i(3), s("x")]), null());
    }
    #[test]
    fn rpad_space() {
...
mod split_part_extra {
    ...
    #[test]
    fn beyond() {
        assert_eq!(eval("split_part", &[s("a,b,c"), s(","), i(4)]), s(""));
    }
    #[test]
    fn no_sep() {
    ...
    #[test]
    fn empty_str() {
        assert_eq!(eval("split_part", &[s(""), s(","), i(1)]), s(""));
    }
    #[test]
    fn null_in() {
    ...
    #[test]
    fn first_of_two() {
        assert_eq!(eval("split_part", &[s("a,b"), s(","), i(1)]), s("a"));
    }
}
...
mod position_extra {
    ...
    #[test]
    fn found() {
        assert_eq!(eval("position", &[s("ell"), s("hello")]), i(2));
    }
    #[test]
    fn not_found() {
    ...
    #[test]
    fn empty_haystack() {
        assert_eq!(eval("position", &[s("a"), s("")]), i(0));
    }
    #[test]
    fn null_in() {
        assert_eq!(eval("position", &[null(), s("a")]), null());
    }
    #[test]
    fn full_match() {
    ...
    #[test]
    fn single_char() {
        assert_eq!(eval("position", &[s("b"), s("abc")]), i(2));
    }
    #[test]
    fn str_pos_alias() {
        assert_eq!(eval("str_pos", &[s("llo"), s("hello")]), i(3));
    }
}
...
mod ascii_chr_extra {
    ...
    #[test]
    fn ascii_multi() {
        assert_eq!(eval("ascii", &[s("hello")]), i(104));
    }
    #[test]
    fn ascii_null() {
...
mod hash_funcs {
    ...
    #[test]
    fn md5_long() {
        let r = eval("md5", &[s(&"a".repeat(1000))]);
        match r {
            Value::Str(v) => assert_eq!(v.len(), 32),
            _ => panic!(),
        }
...
mod regexp_extra {
    ...
    #[test]
    fn match_empty_pat() {
        assert_eq!(eval("regexp_match", &[s("hello"), s("")]), i(1));
    }
    #[test]
    fn match_full() {
    ...
    fn replace_basic() {
        assert_eq!(
            eval("regexp_replace", &[s("hello123"), s("[0-9]+"), s("NUM")]),
            s("helloNUM")
        );
    }
    #[test]
    fn replace_no_match() {
        assert_eq!(
            eval("regexp_replace", &[s("hello"), s("[0-9]+"), s("X")]),
            s("hello")
        );
    }
    #[test]
    fn replace_null() {
        assert_eq!(
            eval("regexp_replace", &[null(), s("[0-9]+"), s("X")]),
            null()
        );
    }
    #[test]
    fn replace_empty() {
        assert_eq!(eval("regexp_replace", &[s(""), s("[0-9]+"), s("X")]), s(""));
    }
    #[test]
    ...
    #[test]
    fn extract_basic() {
        match eval("regexp_extract", &[s("hello123"), s("[0-9]+")]) {
            Value::Str(v) => assert_eq!(v, "123"),
            _ => panic!(),
        }
    }
    #[test]
    fn extract_no_match() {
        assert_eq!(eval("regexp_extract", &[s("hello"), s("[0-9]+")]), null());
    }
    #[test]
    fn extract_null() {
        assert_eq!(eval("regexp_extract", &[null(), s("[0-9]+")]), null());
    }
...
mod conditional_extra {
    ...
    #[test]
    fn coalesce_first() {
        assert_eq!(eval("coalesce", &[s("a"), s("b")]), s("a"));
    }
    #[test]
    fn coalesce_skip_null() {
        assert_eq!(eval("coalesce", &[null(), s("b")]), s("b"));
    }
    #[test]
    ...
    #[test]
    fn coalesce_int() {
        assert_eq!(eval("coalesce", &[null(), i(42)]), i(42));
    }
    #[test]
    fn coalesce_three() {
        assert_eq!(eval("coalesce", &[null(), null(), s("c")]), s("c"));
    }
    ...
    #[test]
    fn nullif_null() {
        assert_eq!(eval("nullif", &[null(), s("a")]), null());
    }
    ...
    #[test]
    fn greatest_str() {
        assert_eq!(eval("greatest", &[s("a"), s("z")]), s("z"));
    }
    #[test]
    ...
    #[test]
    fn least_three() {
        assert_eq!(eval("least", &[i(3), i(1), i(5)]), i(1));
    }
    #[test]
    fn least_str() {
        assert_eq!(eval("least", &[s("a"), s("z")]), s("a"));
    }
    #[test]
    fn least_with_null() {
    ...
    #[test]
    fn if_null_non_null() {
        assert_eq!(eval("if_null", &[i(5), i(0)]), i(5));
    }
    #[test]
    fn if_null_null() {
        assert_eq!(eval("if_null", &[null(), i(0)]), i(0));
    }
    #[test]
    fn if_null_str() {
...
mod translate_extra {
    ...
    fn basic() {
        assert_eq!(
            eval("translate", &[s("hello"), s("el"), s("ip")]),
            s("hippo")
        );
    }
    #[test]
    fn empty() {
        assert_eq!(eval("translate", &[s(""), s("el"), s("ip")]), s(""));
    }
    #[test]
    fn null_in() {
        assert_eq!(eval("translate", &[null(), s("el"), s("ip")]), null());
    }
    #[test]
    fn no_match() {
        assert_eq!(
            eval("translate", &[s("hello"), s("xyz"), s("abc")]),
            s("hello")
        );
    }
    #[test]
    fn single_char() {
        assert_eq!(eval("translate", &[s("abc"), s("b"), s("B")]), s("aBc"));
    }
}
...
mod quote_extra {
    ...
    #[test]
    fn ident_basic() {
        let r = eval("quote_ident", &[s("hello")]);
        match r {
            Value::Str(_) => {}
            _ => panic!(),
        }
    ...
    #[test]
    fn literal_basic() {
        let r = eval("quote_literal", &[s("hello")]);
        match r {
            Value::Str(_) => {}
            _ => panic!(),
        }
    ...
    fn literal_with_quote() {
        let r = eval("quote_literal", &[s("it's")]);
        match r {
            Value::Str(_) => {}
            _ => panic!(),
        }
...
mod format_extra {
    ...
    #[test]
    fn basic() {
        let r = eval("format", &[s("hello %s"), s("world")]);
    ...
    #[test]
    fn multiple() {
        let r = eval("format", &[s("%s and %s"), s("a"), s("b")]);
        assert_eq!(r, s("a and b"));
    }
}
...
mod encoding_extra {
    ...
    #[test]
    fn roundtrip_base64() {
        let enc = eval("to_base64", &[s("hello")]);
        let dec = eval("from_base64", &[enc]);
        assert_eq!(dec, s("hello"));
    }
    #[test]
    fn from_base64_null() {
...
mod url_extra {
    ...
    #[test]
    fn encode_basic() {
        let r = eval("url_encode", &[s("hello world")]);
        match r {
            Value::Str(v) => assert!(v.contains('+') || v.contains("%20")),
            _ => panic!(),
        }
    }
    #[test]
    fn encode_no_change() {
        let r = eval("url_encode", &[s("hello")]);
        assert_eq!(r, s("hello"));
    }
    #[test]
    fn encode_null() {
    ...
    #[test]
    fn roundtrip() {
        let enc = eval("url_encode", &[s("hello world")]);
        let dec = eval("url_decode", &[enc]);
...
mod misc_string {
    ...
    #[test]
    fn word_count_extra_spaces() {
        assert_eq!(eval("word_count", &[s("  a  b  ")]), i(2));
    }
    ...
    #[test]
    fn squeeze_single() {
        assert_eq!(eval("squeeze", &[s("a")]), s("a"));
    }
    ...
    #[test]
    fn count_char_all() {
        assert_eq!(eval("count_char", &[s("aaa"), s("a")]), i(3));
    }
    ...
    #[test]
    fn octet_length_alias() {
        assert_eq!(eval("octet_length", &[s("hi")]), i(2));
    }
...
mod case_conversion {
    ...
    #[test]
    fn camel_basic() {
        let r = eval("camel_case", &[s("hello world")]);
        match r {
            Value::Str(v) => assert!(v.contains("Hello") || v.contains("hello")),
            _ => panic!(),
        }
    }
    #[test]
    ...
    #[test]
    fn snake_basic() {
        let r = eval("snake_case", &[s("helloWorld")]);
        match r {
            Value::Str(v) => assert!(v.contains('_') || v == "helloworld"),
            _ => panic!(),
        }
    }
    #[test]
...
mod strcmp_soundex {
    ...
    #[test]
    fn soundex_same_sound() {
        assert_eq!(
            eval("soundex", &[s("Robert")]),
            eval("soundex", &[s("Rupert")])
        );
    }
}
...
mod concat_ws_extra {
    ...
    #[test]
    fn single_arg() {
        assert_eq!(eval("concat_ws", &[s(","), s("only")]), s("only"));
    }
    #[test]
    fn null_sep() {
        assert_eq!(eval("concat_ws", &[null(), s("a"), s("b")]), null());
    }
}
...
mod cast_extra {
    ...
    #[test]
    fn cast_str_str() {
        assert_eq!(eval("cast_str", &[s("hello")]), s("hello"));
    }
    #[test]
    fn cast_str_null() {
    ...
    fn cast_int_from_float() {
        assert_eq!(eval("cast_int", &[f(3.7)]), i(3));
    }
    #[test]
    fn cast_int_null() {
    ...
    #[test]
    fn to_int_alias() {
        assert_eq!(eval("to_int", &[s("42")]), i(42));
    }
    ...
    #[test]
    fn to_float_alias() {
        assert_eq!(eval("to_float", &[i(42)]), f(42.0));
    }
}
...
mod json_extra {
    ...
    #[test]
    fn extract_basic() {
        let r = eval("json_extract", &[s(r#"{"a":1}"#), s("a")]);
        match r {
            Value::Str(_) | Value::I64(_) => {}
            _ => panic!("got {r:?}"),
        }
    }
    #[test]
    ...
    #[test]
    fn extract_nested() {
        let r = eval("json_extract", &[s(r#"{"a":{"b":2}}"#), s("a")]);
        match r {
            Value::Str(_) => {}
            _ => panic!("got {r:?}"),
        }
...
mod encode_decode {
    ...
    #[test]
    fn roundtrip_encode() {
        let enc = eval("encode", &[s("test"), s("base64")]);
        let dec = eval("decode", &[enc, s("base64")]);
        assert_eq!(dec, s("test"));
    }
    #[test]
    fn encode_empty() {
...
mod overlay_extra {
    ...
    fn basic() {
        assert_eq!(
            eval("overlay", &[s("hello"), s("XX"), i(2), i(3)]),
            s("hXXo")
        );
    }
    #[test]
    fn at_start() {
        assert_eq!(
            eval("overlay", &[s("hello"), s("XX"), i(1), i(2)]),
            s("XXllo")
        );
    }
    #[test]
    fn null_in() {
        assert_eq!(eval("overlay", &[null(), s("XX"), i(1), i(2)]), null());
    }
    #[test]
    fn empty_replace() {
...
mod array_string {
    ...
    #[test]
    fn to_array_basic() {
        let r = eval("string_to_array", &[s("a,b,c"), s(",")]);
        match r {
            Value::Str(_) => {}
            _ => panic!(),
        }
    ...
    #[test]
    fn to_array_empty() {
        let r = eval("string_to_array", &[s(""), s(",")]);
        match r {
            Value::Str(_) => {}
            _ => panic!(),
        }
...
mod system_funcs {
    ...
    #[test]
    fn current_schema_fn() {
        let r = eval("current_schema", &[]);
        match r {
            Value::Str(_) => {}
            _ => panic!(),
        }
    ...
    #[test]
    fn current_database_fn() {
        let r = eval("current_database", &[]);
        match r {
            Value::Str(_) => {}
            _ => panic!(),
        }
...
mod misc_funcs {
    ...
    #[test]
    fn to_json_int() {
        let r = eval("to_json", &[i(42)]);
        match r {
            Value::Str(v) => assert!(v.contains("42")),
            _ => panic!(),
        }
    }
    #[test]
    fn to_json_str() {
        let r = eval("to_json", &[s("hello")]);
        match r {
            Value::Str(_) => {}
            _ => panic!(),
        }
    ...
    #[test]
    fn to_json_null() {
        let r = eval("to_json", &[null()]);
        match r {
            Value::Str(v) => assert!(v.contains("null")),
            _ => panic!(),
        }
    }
    #[test]
    fn table_name_fn() {
        let r = eval("table_name", &[s("my_table")]);
        match r {
            Value::Str(_) => {}
            _ => panic!(),
        }
    ...
    #[test]
    fn table_name_null() {
        assert_eq!(eval("table_name", &[null()]), null());
    }
}
...
mod conditional_advanced {
    ...
    fn nvl2_non_null() {
        assert_eq!(
            eval("nvl2", &[i(1), s("not null"), s("null")]),
            s("not null")
        );
    }
    #[test]
    fn nvl2_null() {
        assert_eq!(eval("nvl2", &[null(), s("not null"), s("null")]), s("null"));
    }
}
...
mod safe_casts {
    ...
    #[test]
    fn safe_int_null() {
        assert_eq!(eval("safe_cast_int", &[null()]), null());
    }
    #[test]
    fn safe_int_empty() {
        assert_eq!(eval("safe_cast_int", &[s("")]), null());
    }
    #[test]
    ...
    fn try_cast_int_alias() {
        assert_eq!(eval("try_cast_int", &[s("42")]), i(42));
    }
    ...
    #[test]
    fn safe_float_invalid() {
        assert_eq!(eval("safe_cast_float", &[s("abc")]), null());
    }
    #[test]
    fn safe_float_null() {
        assert_eq!(eval("safe_cast_float", &[null()]), null());
    }
    #[test]
    fn safe_float_empty() {
        assert_eq!(eval("safe_cast_float", &[s("")]), null());
    }
    #[test]
...
mod numeric_string {
    ...
    #[test]
    fn reciprocal_basic() {
        let r = eval("reciprocal", &[f(4.0)]);
        match r {
            Value::F64(v) => assert!((v - 0.25).abs() < 0.001),
            _ => panic!(),
        }
    }
    #[test]
    fn reciprocal_one() {
        let r = eval("reciprocal", &[f(1.0)]);
        match r {
    ...
    #[test]
    fn signum_zero() {
        assert_eq!(eval("signum", &[i(0)]), i(0));
    }
    #[test]
    fn signum_null() {
        assert_eq!(eval("signum", &[null()]), null());
    }
}
