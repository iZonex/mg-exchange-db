...
mod sin_tests {
    ...
    sin_t!(s_pi4, FRAC_PI_4, std::f64::consts::FRAC_1_SQRT_2);
...
mod cos_tests {
    ...
    cos_t!(c_pi4, FRAC_PI_4, std::f64::consts::FRAC_1_SQRT_2);
...
mod sqrt_tests {
    ...
    sq!(s00, 0.0, 0.0);
    sq!(s01, 1.0, 1.0);
    sq!(s02, 2.0, std::f64::consts::SQRT_2);
    sq!(s03, 3.0, 1.7321);
    sq!(s04, 4.0, 2.0);
    sq!(s05, 5.0, 2.2361);
    sq!(s06, 6.0, 2.4495);
    ...
    sq!(s33, 0.5, std::f64::consts::FRAC_1_SQRT_2);
    sq!(s34, 1.5, 1.2247);
    sq!(s35, 2.5, 1.5811);
    sq!(s36, 3.5, 1.8708);
    sq!(s37, 4.5, 2.1213);
...
mod pow_tests {
    ...
    pw!(p33, 2.0, 0.5, std::f64::consts::SQRT_2);
    pw!(p34, 4.0, 0.5, 2.0);
    pw!(p35, 9.0, 0.5, 3.0);
    pw!(p36, 2.0, -1.0, 0.5);
    pw!(p37, 2.0, -2.0, 0.25);
...
mod log_tests {
    ...
    lg!(l01, 1.0, 0.0);
    lg!(l02, 2.728281828, 1.0);
    lg!(l03, 7.389, 2.0);
    lg!(l04, 20.086, 3.0);
    lg!(l05, 2.0, std::f64::consts::LN_2);
    lg!(l06, 3.0, 1.0986);
    lg!(l07, 4.0, 1.3863);
    lg!(l08, 5.0, 1.6094);
    lg!(l09, 10.0, std::f64::consts::LN_10);
    lg!(l10, 100.0, 4.6052);
    lg!(l11, 1000.0, 6.9078);
    lg!(l12, 0.5, -std::f64::consts::LN_2);
    lg!(l13, 0.1, -std::f64::consts::LN_10);
    lg!(l14, 0.01, -4.6052);
    lg!(l15, 50.0, 3.912);
    lg!(l16, 25.0, 3.2189);
    lg!(l17, 75.0, 4.3175);
