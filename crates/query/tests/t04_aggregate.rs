...
mod sum_t04 {
    ...
    fn large_val() {
        ...
        a.add(&i(1_000_000));
        a.add(&i(2_000_000));
        assert_eq!(a.result(), i(3_000_000));
    }
    #[test]
    fn s01() {
        let mut a = Sum::default();
    ...
    fn s04() {
        ...
        assert_eq!(a.result(), i(1275));
    }
    #[test]
    fn s05() {
        let mut a = Sum::default();
        feed(&mut a, &[f(0.1), f(0.2), f(0.3)]);
        close(&a.result(), 0.6, 0.01);
    }
    #[test]
    fn s06() {
        let mut a = Sum::default();
        feed(&mut a, &[i(10), i(20), i(30)]);
        assert_eq!(a.result(), i(60));
    }
    #[test]
    fn s07() {
        let mut a = Sum::default();
    ...
    fn s11() {
        ...
        a.add(&i(i64::MAX / 2));
        a.add(&i(1));
        assert!(matches!(a.result(), Value::I64(v) if v > 0));
    }
    #[test]
    fn s12() {
        let mut a = Sum::default();
        feed(&mut a, &[null(), null(), i(42)]);
        assert_eq!(a.result(), i(42));
    }
    #[test]
    fn s13() {
        let mut a = Sum::default();
        feed(&mut a, &[i(42), null(), null()]);
        assert_eq!(a.result(), i(42));
    }
    #[test]
    fn s14() {
    ...
    fn s22() {
        let mut a = Sum::default();
        feed(&mut a, &[i(50), i(50)]);
        assert_eq!(a.result(), i(100));
    }
    #[test]
    fn s23() {
        let mut a = Sum::default();
        feed(&mut a, &[i(33), i(33), i(34)]);
        assert_eq!(a.result(), i(100));
    }
    #[test]
    fn s24() {
        let mut a = Sum::default();
        feed(&mut a, &[i(25), i(25), i(25), i(25)]);
        assert_eq!(a.result(), i(100));
    }
    #[test]
    fn s25() {
    ...
    fn s29() {
        let mut a = Sum::default();
        feed(&mut a, &[i(4), i(4), i(4), i(4)]);
        assert_eq!(a.result(), i(16));
    }
    #[test]
    fn s30() {
        let mut a = Sum::default();
        feed(&mut a, &[i(5), i(5), i(5), i(5), i(5)]);
        assert_eq!(a.result(), i(25));
    }
    #[test]
    fn s31() {
        let mut a = Sum::default();
        feed(&mut a, &[i(6), i(6), i(6), i(6), i(6), i(6)]);
        assert_eq!(a.result(), i(36));
    }
    #[test]
    fn s32() {
        let mut a = Sum::default();
        feed(&mut a, &[i(7), i(7), i(7), i(7), i(7), i(7), i(7)]);
        assert_eq!(a.result(), i(49));
    }
    #[test]
    fn s33() {
        let mut a = Sum::default();
        feed(&mut a, &[i(8), i(8), i(8), i(8), i(8), i(8), i(8), i(8)]);
        assert_eq!(a.result(), i(64));
    }
    #[test]
    fn s34() {
        let mut a = Sum::default();
        feed(
            &mut a,
            &[i(9), i(9), i(9), i(9), i(9), i(9), i(9), i(9), i(9)],
        );
        assert_eq!(a.result(), i(81));
    }
    #[test]
    fn s35() {
        let mut a = Sum::default();
...
mod avg_t04 {
    ...
    fn a04() {
        let mut a = Avg::default();
        feed(&mut a, &[i(0), i(100)]);
        close(&a.result(), 50.0, 0.01);
    }
    #[test]
    fn a05() {
        let mut a = Avg::default();
        feed(&mut a, &[f(0.5), f(1.5)]);
        close(&a.result(), 1.0, 0.01);
    }
    #[test]
    fn a06() {
    ...
    fn a16() {
        ...
        close(&a.result(), 500.5, 0.01);
    }
    #[test]
    fn a17() {
        let mut a = Avg::default();
        feed(&mut a, &[i(10), i(20), null(), i(30)]);
        close(&a.result(), 20.0, 0.01);
    }
    #[test]
    fn a18() {
...
mod min_t04 {
    ...
    fn m02() {
        let mut a = Min::default();
        feed(&mut a, &[i(30), i(20), i(10)]);
        assert_eq!(a.result(), i(10));
    }
    #[test]
    fn m03() {
        let mut a = Min::default();
        feed(&mut a, &[i(20), i(10), i(30)]);
        assert_eq!(a.result(), i(10));
    }
    #[test]
    fn m04() {
    ...
    fn m16() {
        let mut a = Min::default();
        feed(&mut a, &[f(0.5), f(0.1)]);
        assert_eq!(a.result(), f(0.1));
    }
    #[test]
    fn m17() {
        let mut a = Min::default();
        feed(&mut a, &[f(0.1), f(0.5)]);
        assert_eq!(a.result(), f(0.1));
    }
    #[test]
    fn m18() {
    ...
    fn m19() {
        let mut a = Min::default();
        feed(&mut a, &[i(3), null(), i(1), null(), i(2)]);
        assert_eq!(a.result(), i(1));
    }
    #[test]
    fn m20() {
    ...
    fn m21() {
        let mut a = Min::default();
        feed(&mut a, &[i(5), i(3), i(7), i(1), i(9)]);
        assert_eq!(a.result(), i(1));
    }
    #[test]
    fn m22() {
        let mut a = Min::default();
        feed(&mut a, &[i(9), i(7), i(5), i(3), i(1)]);
        assert_eq!(a.result(), i(1));
    }
    #[test]
    fn m23() {
        let mut a = Min::default();
        feed(&mut a, &[i(2), i(4), i(6), i(8), i(10)]);
        assert_eq!(a.result(), i(2));
    }
    #[test]
    fn m24() {
    ...
    fn m25() {
        let mut a = Min::default();
        feed(&mut a, &[f(1.0), f(2.0), f(0.5)]);
        assert_eq!(a.result(), f(0.5));
    }
    #[test]
    fn m26() {
        let mut a = Min::default();
        feed(&mut a, &[i(-50), i(-30), i(-10)]);
        assert_eq!(a.result(), i(-50));
    }
    #[test]
    fn m27() {
...
mod max_t04 {
    ...
    fn x12() {
        let mut a = Max::default();
        feed(&mut a, &[i(3), null(), i(7), null(), i(5)]);
        assert_eq!(a.result(), i(7));
    }
    #[test]
    fn x13() {
    ...
    fn x14() {
        let mut a = Max::default();
        feed(&mut a, &[f(0.1), f(0.9)]);
        assert_eq!(a.result(), f(0.9));
    }
    #[test]
    fn x15() {
        let mut a = Max::default();
    ...
    fn x17() {
        let mut a = Max::default();
        feed(&mut a, &[s("a"), s("z")]);
        assert_eq!(a.result(), s("z"));
    }
    #[test]
    fn x18() {
        let mut a = Max::default();
        feed(&mut a, &[i(50), i(25), i(75)]);
        assert_eq!(a.result(), i(75));
    }
    #[test]
    fn x19() {
        let mut a = Max::default();
    ...
    fn x22() {
        let mut a = Max::default();
        feed(&mut a, &[f(0.5), f(1.5), f(2.5)]);
        assert_eq!(a.result(), f(2.5));
    }
    #[test]
    fn x23() {
        let mut a = Max::default();
    ...
    fn x25() {
        let mut a = Max::default();
        feed(&mut a, &[i(1000000)]);
        assert_eq!(a.result(), i(1000000));
    }
    #[test]
    fn x26() {
        let mut a = Max::default();
...
mod first_last_t04 {
    ...
    fn fl03() {
        let mut a = First::default();
        feed(&mut a, &[null(), null(), i(5)]);
        assert_eq!(a.result(), i(5));
    }
    #[test]
    fn fl04() {
        let mut a = Last::default();
        feed(&mut a, &[i(5), null(), null()]);
        assert_eq!(a.result(), i(5));
    }
    #[test]
    fn fl05() {
    ...
    fn fl19() {
        let mut a = First::default();
        feed(&mut a, &[ts(1000), ts(2000)]);
        assert_eq!(a.result(), ts(1000));
    }
    #[test]
    fn fl20() {
        let mut a = Last::default();
        feed(&mut a, &[ts(1000), ts(2000)]);
        assert_eq!(a.result(), ts(2000));
    }
}
...
mod stats_t04 {
    ...
    fn var_null_skip() {
        let mut a = Variance::default();
        feed(&mut a, &[i(1), null(), i(3)]);
        assert!(matches!(a.result(), Value::F64(_)));
    }
    #[test]
    fn var_all_null() {
        let mut a = Variance::default();
    ...
    fn var_floats() {
        let mut a = Variance::default();
        feed(&mut a, &[f(1.0), f(2.0), f(3.0)]);
        assert!(matches!(a.result(), Value::F64(v) if v > 0.0));
    }
    #[test]
    fn var_large() {
        let mut a = Variance::default();
    ...
    #[test]
    fn var_is_stddev_sq() {
        let vals = vec![i(2), i(4), i(6)];
        let mut s = StdDev::default();
        feed(&mut s, &vals);
        let mut v = Variance::default();
        feed(&mut v, &vals);
        let sd = match s.result() {
            Value::F64(x) => x,
            _ => panic!(),
        };
        let va = match v.result() {
            Value::F64(x) => x,
            _ => panic!(),
        };
        assert!((va - sd * sd).abs() < 0.01);
    }
    #[test]
    fn med_empty() {
    ...
    fn st01() {
        ...
        feed(&mut a, &[i(1), i(2), i(3)]);
        let r = a.result();
        assert!(matches!(r, Value::F64(v) if v > 0.0 && v < 2.0));
    }
    #[test]
    fn st02() {
        let mut a = Variance::default();
    ...
    fn st06() {
        let mut a = Median::default();
        feed(&mut a, &[i(10), i(20), i(30), i(40)]);
        close(&a.result(), 25.0, 0.01);
    }
    #[test]
    fn st07() {
        let mut a = StdDev::default();
        feed(&mut a, &[i(10), i(10), i(10)]);
        close(&a.result(), 0.0, 0.01);
    }
    #[test]
    fn st08() {
...
mod cd_t04 {
    ...
    fn cd01() {
        let mut a = CountDistinct::default();
        feed(&mut a, &[i(1), i(2), i(1), i(2)]);
        assert_eq!(a.result(), i(2));
    }
    #[test]
    fn cd02() {
        let mut a = CountDistinct::default();
        feed(&mut a, &[i(1), i(2), i(3), i(1), i(2), i(3)]);
        assert_eq!(a.result(), i(3));
    }
    #[test]
    fn cd03() {
        let mut a = CountDistinct::default();
        feed(&mut a, &[s("x"), s("y"), s("x")]);
        assert_eq!(a.result(), i(2));
    }
    #[test]
    fn cd04() {
    ...
    fn cd18() {
        let mut a = CountDistinct::default();
        feed(&mut a, &[s("a"), s("b"), s("c"), s("a"), s("b"), s("c")]);
        assert_eq!(a.result(), i(3));
    }
    #[test]
    fn cd19() {
        let mut a = CountDistinct::default();
        feed(&mut a, &[i(1), f(1.0)]);
        assert!(a.result() != i(0));
    }
    #[test]
    fn cd20() {
...
mod stragg_t04 {
    ...
    fn space_sep() {
        let mut a = StringAgg::new(" ".to_string());
        feed(&mut a, &[s("hello"), s("world")]);
        assert_eq!(a.result(), s("hello world"));
    }
    #[test]
    fn sa01() {
        let mut a = StringAgg::default();
        feed(&mut a, &[s("x")]);
        assert_eq!(a.result(), s("x"));
    }
    #[test]
    fn sa02() {
        let mut a = StringAgg::new("|".to_string());
    ...
    fn sa04() {
        ...
        assert_eq!(a.result(), s("0,1,2,3,4"));
    }
    #[test]
    fn sa05() {
        let mut a = StringAgg::default();
    ...
    fn sa09() {
        ...
        let r = match a.result() {
            Value::Str(v) => v,
            _ => panic!(),
        };
        assert_eq!(r.matches(',').count(), 9);
    }
    #[test]
    fn sa10() {
        let mut a = StringAgg::new(";".to_string());
        feed(&mut a, &[s("a"), s("b"), s("c"), s("d")]);
        assert_eq!(a.result(), s("a;b;c;d"));
    }
}
...
mod pct_t04 {
    ...
    #[test]
    fn one() {
        let mut a = PercentileCont::default();
        a.add(&i(42));
        close(&a.result(), 42.0, 0.01);
    }
    #[test]
    ...
    fn p25() {
        ...
        feed(&mut a, &[i(1), i(2), i(3), i(4)]);
        close(&a.result(), 1.75, 0.01);
    }
    #[test]
    fn p75() {
        let mut a = PercentileCont::new(0.75);
        feed(&mut a, &[i(1), i(2), i(3), i(4)]);
        close(&a.result(), 3.25, 0.01);
    }
    #[test]
    fn p0() {
